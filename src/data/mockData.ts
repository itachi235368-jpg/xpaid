...
export const INITIAL_TOKENS: TokenLaunchData[] = [
  ...
  {
    id: 'tok-pons-robinhood-hood',
    name: 'Robinhood Meme',
    symbol: 'HOODIE',
    description: 'Autonomous community token launched on Pons (Robinhood Chain L2). 95% creator trading fees routed directly to @vladtenev via 𝕏 Money & Robinhood USD accounts.',
    logoUrl: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=200&auto=format&fit=crop&q=80',
    platform: 'pons',
    network: 'robinhood',
    beneficiaryXHandle: '@vladtenev',
    beneficiaryName: 'Vlad Tenev',
    beneficiaryAvatar: 'https://unavatar.io/x/vladtenev',
    initialBuyAmount: 50,
    feeSplitPct: 95,
    mintAddress: '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063pons',
    pairAddress: '0x3a4c5e6d7f8e9a0b1c2d3e4f5a6b7c8d9e0f1a2b',
    beneficiaryAccount: '0x2B9c89280F33DbE1A616B88981e4b47B58BdB241',
    creatorFeeRecipient: '0x2B9c89280F33DbE1A616B88981e4b47B58BdB241',
    marketCapUsd: 12450.00,
    volume24hUsd: 3820.00,
    bondingCurveProgress: 18.5,
    createdAt: new Date().toISOString(),
    creatorWallet: '0x2B9c89280F33DbE1A616B88981e4b47B58BdB241',
    status: 'active',
    twitterLink: 'https://x.com/vladtenev',
  }
];
