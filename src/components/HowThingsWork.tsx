...
export const HowThingsWork: React.FC<HowThingsWorkProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      {/* Feature Comparison Table: Traditional vs Xpaid */}
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8 shadow-sm">
        <div className="mb-6">
          <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100">
            Why Xpaid is Different
          </h3>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            Compare standard meme token creation with Xpaid's frictionless 𝕏 Money rail.
          </p>
        </div>
          ...
          <table className="w-full text-left text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-800 text-zinc-400 uppercase text-[11px]">
                ...
                <th className="pb-3 font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50/50 dark:bg-emerald-950/40 px-4 rounded-t-lg">Xpaid System</th>
              </tr>
            </thead>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8 shadow-sm space-y-6">
        <div>
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            Common questions about the Xpaid protocol, fees, and 𝕏 Money settlement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs sm:text-sm">
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/80 dark:border-zinc-700/80 space-y-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              No. That is the core innovation of Xpaid. You can launch a token honoring any creator (like @elonmusk, @cz_binance, or a favorite artist), and royalties are deposited into their 𝕏 Money balance automatically.
            </p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/80 dark:border-zinc-700/80 space-y-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Pump.fun's Solana smart contracts enforce a 1% creator fee on every trade along the bonding curve. Xpaid sets the verified Protocol Treasury as the fee collection authority.
            </p>
          </div>
